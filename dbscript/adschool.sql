...
-- -----------------------------------------------------
-- Schema COLLEGEKONNET
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `COLLEGEKONNET` ;

-- -----------------------------------------------------
-- Schema COLLEGEKONNET
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `COLLEGEKONNET` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `COLLEGEKONNET` ;

-- -----------------------------------------------------
-- Table `COLLEGEKONNET`.`SCHOOL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COLLEGEKONNET`.`SCHOOL` ;

CREATE TABLE IF NOT EXISTS `COLLEGEKONNET`.`SCHOOL` (
...
-- -----------------------------------------------------
-- Table `COLLEGEKONNET`.`USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COLLEGEKONNET`.`USER` ;

CREATE TABLE IF NOT EXISTS `COLLEGEKONNET`.`USER` (
  ...
  CONSTRAINT `fk_USER_SCHOOL1`
    ...
    REFERENCES `COLLEGEKONNET`.`SCHOOL` (`IDT_SCHOOL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `COLLEGEKONNET`.`EVENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COLLEGEKONNET`.`EVENT` ;

CREATE TABLE IF NOT EXISTS `COLLEGEKONNET`.`EVENT` (
...
-- -----------------------------------------------------
-- Table `COLLEGEKONNET`.`CREATOR_EVENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COLLEGEKONNET`.`CREATOR_EVENT` ;

CREATE TABLE IF NOT EXISTS `COLLEGEKONNET`.`CREATOR_EVENT` (
  ...
  CONSTRAINT `fk_USER_EVENT_USER`
    ...
    REFERENCES `COLLEGEKONNET`.`USER` (`IDT_USER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USER_EVENT_EVENT1`
    FOREIGN KEY (`EVENT_IDT_EVENT`)
    REFERENCES `COLLEGEKONNET`.`EVENT` (`IDT_EVENT`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `COLLEGEKONNET`.`USER_EVENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COLLEGEKONNET`.`USER_EVENT` ;

CREATE TABLE IF NOT EXISTS `COLLEGEKONNET`.`USER_EVENT` (
  `IDT_USER_EVENT` INT NOT NULL,
  `USER_IDT_USER` INT NOT NULL,
  `EVENT_IDT_EVENT` INT NOT NULL,
...
GRANT ALL ON `COLLEGEKONNET`.* TO 'ROOT_ADSCHOOL';
SET SQL_MODE = '';
...
GRANT SELECT, INSERT, TRIGGER ON TABLE `COLLEGEKONNET`.* TO 'APP_ADSCHOOL';
GRANT SELECT ON TABLE `COLLEGEKONNET`.* TO 'APP_ADSCHOOL';
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `COLLEGEKONNET`.* TO 'APP_ADSCHOOL';
...
-- -----------------------------------------------------
-- Data for table `COLLEGEKONNET`.`SCHOOL`
-- -----------------------------------------------------
START TRANSACTION;
USE `COLLEGEKONNET`;
INSERT INTO `COLLEGEKONNET`.`SCHOOL` (`IDT_SCHOOL`, `NAM_SCHOOL`, `LAT_LOC_SCHOOL`, `LON_LOC_SCHOOL`, `SUF_SCHOOL`) VALUES (1, 'Lehman College', 40.8725, -73.8939, 'lc.cuny.edu');
INSERT INTO `COLLEGEKONNET`.`SCHOOL` (`IDT_SCHOOL`, `NAM_SCHOOL`, `LAT_LOC_SCHOOL`, `LON_LOC_SCHOOL`, `SUF_SCHOOL`) VALUES (2, 'City College of New York', 40.8194, -73.9500, 'ccny.cuny.edu');
INSERT INTO `COLLEGEKONNET`.`SCHOOL` (`IDT_SCHOOL`, `NAM_SCHOOL`, `LAT_LOC_SCHOOL`, `LON_LOC_SCHOOL`, `SUF_SCHOOL`) VALUES (3, 'Columbia University', 40.8075, -73.9619, 'columbia.edu');

COMMIT;


-- -----------------------------------------------------
-- Data for table `COLLEGEKONNET`.`USER`
-- -----------------------------------------------------
START TRANSACTION;
USE `COLLEGEKONNET`;
INSERT INTO `COLLEGEKONNET`.`USER` (`IDT_USER`, `FNM_USER`, `LNM_USER`, `PMS_USER`, `PSW_USER`, `EML_USER`, `CPN_USER`, `SND_EML_USER`, `IMG_USER`, `SCHOOL_IDT_SCHOOL`) VALUES (1, 'TEST', 'TEST', 1, '098f6bcd4621d373cade4e832627b4f6', 'test@test.com', '9548168660', 'test2@test.com', 'test.jpg', 1);
