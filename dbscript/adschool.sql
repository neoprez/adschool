...
CREATE TABLE IF NOT EXISTS `COLLEGE_KONNET`.`SCHOOL` (
  `IDT_SCHOOL` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `COLLEGE_KONNET`.`EVENT` (
  ...
  `DAT_STR_EVENT` TEXT NOT NULL COMMENT 'START TIME OF EVENT',
  `DAT_END_EVENT` TEXT NOT NULL COMMENT 'END TIME OF EVENT',
...
CREATE TABLE IF NOT EXISTS `COLLEGE_KONNET`.`CREATOR_EVENT` (
  `IDT_USER_EVENT` INT NOT NULL AUTO_INCREMENT,
